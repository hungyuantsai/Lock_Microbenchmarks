#include "all.hpp"
#define OMCS_OP_READ OMCS_OFFSET
...
class OMCSLock {
 ...
 public:
  ...
  /*X*/inline bool lock_begin(OMCSQNode *qnode) {
  ...
  /*X*/inline void lock_turn_off_opread() {
#ifdef OMCS_OP_READ
#ifdef OMCS_OFFSET
